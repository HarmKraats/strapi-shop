...
global $orders_database, $strapi_database;

$orders_database = new DatabaseConnection('localhost', 'lillshop_orders', 'root', '');
$strapi_database = new DatabaseConnection('localhost', 'lillshop', 'root', '');
